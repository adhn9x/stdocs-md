...
* If the specifiedthread\_id points to an unthreaded message, the API will return error code 4010.
...
**End Point**: <u>[https://openapi.seatalk.io/messaging/v2/group\_chat/](https://openapi.seatalk.io/messaging/v2/group_chat)get\_thread\_by\_thread\_id</u>
...
|thread\_id|string|Yes|The thread ID|N/A||
...
https://openapi.seatalk.io/messaging/v2/group\_chat/get\_thread\_by\_thread\_id?group\_id=abcdef&thread\_id=uytreb&page\_size=50
...
|thread\_messages|\[\] object|List of Message object||
...
|∟seatalk\_id|string|- Mention specific user or bot: SeaTalk ID||
|∟employee\_code|string|- Mention specific user: Employee Code - Mention specific bot: Empty||
