...
1. **text messages with/without formatting**
2. **images**
...
* To call this API, your app must enable the**bot capability**and have an**Online**status. See more at[Quickly build a Bot](/docs/quickly-build-a-bot).
...
**End Point**:https://openapi.seatalk.io/messaging/v2/single\_chat
...
|---|---|---|---|---|---|---|
|employee\_code|string|Yes|The employee\_code of the user|N/A|N/A|"e\_12345678"|
...
|∟tag|string|Yes|The type of the message, in this case, is 'interactive\_message'.|
|∟interactive\_message|object|Yes|The interactive message object|
...
|---|---|---|
|code|int|Refer to Error Code for explanations|
|message\_id|string|The id of the sent out message|
