...
1. **What is the list of entities the request wants to retrieve**(e.g. a list of employees under department "Shopee → Singapore", or a list of departments under "Shopee → Singapore")
2. What is the**length of the list**to be retrieved**in this request**(e.g. 10 items or 50 items)
...
After receiving the response, you can**put the "next\_cursor" info into the "cursor" section in the new** **request** together with the desired item length to get the next batch of responses and a new cursor.
