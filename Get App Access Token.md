...
**End Point**: https://openapi.seatalk.io/auth/app\_access\_token
...
|Parameter|Type|Mandatory|Description|Default|Sample|
|---|---|---|---|---|---|
|app\_id|string|Yes|The unique identifier of an app|N/A|123|
|app\_secret|string|Yes|The credential of an app|N/A|V79JzZ0yasBAs69tQOD1|
...
|app\_access\_token|string|The access token generated for the app|
