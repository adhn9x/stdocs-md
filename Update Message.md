...
* All elements of the message card can be updated, and it must follow the [card building rule](https://open.seatalk.io/docs/interactive-msg_build-a-card#Card%20Building%20Rules-2)
...
|---|---|---|---|---|---|
|message\_id|string|Yes|The message ID|N/A|N/A|
|message|object|Yes|The message to be updated|N/A|N/A|
|∟interactive\_message|object|Yes|The interactive message card object|N/A|N/A|
